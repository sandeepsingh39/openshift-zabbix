...
# Subject = $1 (usually either OK or PROBLEM)
# Message = $2 (whatever message the Zabbix action sends,
...
curl -X POST -H 'Content-Type: application/json' --data "${payload}" $url 2>&1 >>${LOGFILE}
